...
import HeartNotificationPopup from '../notifications/HeartNotificationPopup';
...
const FooterNav = () => {
  ...
  // Real-time notifications for heart icon popup
  const {
    popupNotifications,
        ...
        <footer className="w-[400px] max-w-[90%] bg-white/30 backdrop-blur-md rounded-full px-8 py-4 flex justify-between items-center shadow-lg border border-white/20">
          ...
          <button
            ...
            onClick={() => {
              ...
              // Immediately hide the red dot when clicking notifications
              markAsRead();
              // Also refresh unread count when navigating to notifications
